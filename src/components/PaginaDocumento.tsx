    ...
    <div className="min-h-screen bg-white dark:bg-slate-950 text-[#0f1e36] dark:text-slate-100 font-sans selection:bg-[#d4af37]/35 transition-colors duration-300 pb-20 print:bg-white print:text-black">
      ...
      <header className="sticky top-0 z-50 bg-white/95 dark:bg-slate-950/95 border-b border-slate-200 dark:border-slate-800/80 backdrop-blur-md px-6 py-4 flex items-center justify-between shadow-sm print:relative print:border-none print:shadow-none print:bg-white">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="font-playfair font-extrabold text-lg sm:text-xl tracking-wide text-[#0f1e36] dark:text-slate-100 uppercase">
              Janaina Tarabauca
            </h1>
            <p className="text-sm sm:text-base uppercase tracking-widest text-[#d4af37] font-bold">
        ...
        <button
          ...
          className="bg-[#0f1e36] text-white hover:bg-slate-800 text-sm sm:text-base font-bold uppercase px-4 py-2 rounded border-b border-[#d4af37] print:hidden transition-all duration-200 active:scale-95 shadow-sm"
        >
      ...
      <main className="max-w-5xl mx-auto px-6 pt-8 space-y-12">
        ...
        <section className="text-center space-y-4 print:text-left">
          ...
          <p className="text-lg text-slate-750 dark:text-slate-350 max-w-2xl mx-auto print:mx-0 leading-relaxed font-normal">
          ...
          <div className="flex flex-wrap items-center justify-center gap-2 pt-2 print:hidden">
            {(["todos", "escopo", "arquitetura", "manual"] as const).map((sec) => (
              <button
                ...
                className={`px-4 py-2 rounded-full text-sm sm:text-base font-bold uppercase tracking-wider transition-all border ${
                  activeSection === sec
        ...
        {(activeSection === "todos" || activeSection === "escopo") && (
          <section className="space-y-6 animate-fadeIn">
            <div className="flex items-center gap-2 border-b border-slate-200 dark:border-slate-800 pb-2">
              ...
              <h3 className="font-playfair font-extrabold text-2xl md:text-3xl text-[#0f1e36] dark:text-slate-100 uppercase tracking-wider">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="border border-[#d4af37]/35 dark:border-[#d4af37]/20 rounded-xl p-5 bg-slate-50/50 dark:bg-slate-900/40 space-y-3">
                <span className="text-sm sm:text-base font-bold text-[#d4af37] uppercase tracking-widest font-mono">Objetivo Estratégico</span>
                <h4 className="font-playfair font-bold text-lg sm:text-xl text-[#0f1e36] dark:text-slate-100">
                  Gestão Digital de Alta Complexidade em Direito Médico e da Saúde
                </h4>
                <p className="text-base sm:text-lg text-slate-650 dark:text-slate-350 leading-relaxed font-normal">
              ...
              <div className="border border-slate-200 dark:border-slate-800/80 rounded-xl p-5 bg-slate-50/50 dark:bg-slate-900/40 space-y-3">
                <span className="text-sm sm:text-base font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest font-mono">Público-Alvo e Usuários</span>
                <h4 className="font-playfair font-bold text-lg sm:text-xl text-[#0f1e36] dark:text-slate-100">
                  Corpo Jurídico e Clientes Corporativos de Saúde
                </h4>
                <ul className="text-base sm:text-lg text-slate-650 dark:text-slate-350 space-y-2 font-normal list-inside list-disc">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="border border-slate-200 dark:border-slate-800 rounded-xl p-5 space-y-3 bg-slate-50/50 dark:bg-slate-900/40">
                <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-2">
                  <span className="text-sm sm:text-base font-bold uppercase tracking-wider text-slate-400">Camada de Client</span>
                  <span className="text-xs bg-slate-200 dark:bg-slate-800 px-2 py-0.5 rounded font-mono font-bold">SPA</span>
                </div>
                <h4 className="font-bold text-[#0f1e36] dark:text-slate-200 text-lg sm:text-xl">React.js &amp; TypeScript</h4>
                <p className="text-base sm:text-lg text-slate-650 dark:text-slate-350 leading-relaxed font-normal">
              ...
              <div className="border border-slate-200 dark:border-slate-800 rounded-xl p-5 space-y-3 bg-slate-50/50 dark:bg-slate-900/40">
                <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-2">
                  <span className="text-sm sm:text-base font-bold uppercase tracking-wider text-slate-400">Banco de Dados</span>
                  <span className="text-xs bg-[#d4af37]/10 text-[#d4af37] px-2 py-0.5 rounded font-mono font-bold">Supabase</span>
                </div>
                <h4 className="font-bold text-[#0f1e36] dark:text-slate-200 text-lg sm:text-xl">PostgreSQL Relacional</h4>
                <p className="text-base sm:text-lg text-slate-650 dark:text-slate-350 leading-relaxed font-normal">
              ...
              <div className="border border-[#d4af37]/35 dark:border-[#d4af37]/20 rounded-xl p-5 space-y-3 bg-slate-50/50 dark:bg-slate-900/40">
                <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-2">
                  <span className="text-sm sm:text-base font-bold uppercase tracking-wider text-[#d4af37]">Motor Cognitivo</span>
                  <span className="text-xs bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 px-2 py-0.5 rounded font-mono font-bold">Jus IA</span>
                </div>
                <h4 className="font-bold text-[#0f1e36] dark:text-slate-200 text-lg sm:text-xl">Integração "Jus IA" Nativa</h4>
                <p className="text-base sm:text-lg text-slate-650 dark:text-slate-350 leading-relaxed font-normal">
          ...
          <section className="space-y-6 animate-fadeIn">
            ...
            <div className="flex gap-2 border-b border-slate-100 dark:border-slate-800 pb-3 print:hidden">
              <button
                ...
                className={`px-3 py-2 text-sm sm:text-base font-bold uppercase tracking-wider border-b-2 transition-all ${
            ...
            {(activeModule === "processos" || activeSection === "todos") && (
              <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 items-start animate-slideDown">
                <div className="lg:col-span-3 space-y-4">
                  <span className="text-sm sm:text-base font-bold text-slate-400 uppercase tracking-widest font-mono">Fluxo Operacional</span>
                  <h4 className="font-playfair font-bold text-xl md:text-2xl text-[#0f1e36] dark:text-slate-200">
                  ...
                  <div className="bg-slate-50 dark:bg-slate-900 border-l-2 border-[#d4af37] p-4 rounded-r-lg space-y-2">
                    <span className="text-sm font-mono font-bold text-[#d4af37] uppercase tracking-wide">💡 Dica de Utilização</span>
                    <p className="text-base sm:text-lg text-slate-650 dark:text-slate-350 leading-relaxed font-normal">
                ...
                <div className="lg:col-span-2 border border-[#d4af37] rounded-xl p-5 bg-slate-50 dark:bg-[#070a13] font-mono text-sm text-slate-650 dark:text-slate-350 space-y-4 relative shadow-md">
                  <span className="absolute top-2 right-2 text-xs sm:text-sm uppercase tracking-wider text-[#d4af37] border border-[#d4af37]/30 px-2 py-0.5 rounded bg-[#d4af37]/5 font-bold">Screenshot: Processos</span>
                  <div className="border border-slate-300 dark:border-slate-800 p-3.5 rounded-lg bg-white dark:bg-slate-900 flex justify-between items-center text-[#0f1e36] dark:text-slate-100 font-sans shadow-sm">
                    <div className="space-y-1">
                      <span className="font-extrabold text-sm sm:text-base">Processo nº 1004523-89.2026.8.26.0100</span>
                      <p className="text-xs sm:text-sm text-slate-550 dark:text-slate-400">Dr. Eduardo Santos vs. Unimed Grande São Paulo</p>
                    </div>
                    <span className="text-xs sm:text-sm font-bold text-[#d4af37] bg-[#d4af37]/10 px-2.5 py-1 rounded border border-[#d4af37]/25 uppercase">CRM Defesa</span>
                  </div>
                  
                  <div className="space-y-2">
                    <div className="h-2 w-1/3 bg-slate-200 dark:bg-slate-800 rounded"></div>
                    <div className="border border-dashed border-slate-300 dark:border-slate-850 p-4 rounded-lg text-center cursor-pointer hover:bg-slate-100 dark:hover:bg-slate-800/40 transition-all text-sm sm:text-base">
                      📎 Arraste prontuários adicionais ou defesas do CRM (.pdf, .txt)
                    </div>
                  </div>

                  <div className="bg-[#0f1e36] text-white p-3.5 rounded-lg flex items-center justify-between border-b border-[#d4af37] font-sans">
                    <span className="text-xs sm:text-sm font-bold">🤖 Motor: JUS IA (Padrão)</span>
                    <span className="text-xs sm:text-sm text-emerald-400 animate-pulse font-bold">● Pronto para Redigir</span>
                  </div>
                </div>
              </div>
            )}
            ...
            {(activeModule === "contratos" || activeSection === "todos") && (
              <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 items-start pt-6 border-t border-slate-100 dark:border-slate-900/60 animate-slideDown">
                <div className="lg:col-span-3 space-y-4">
                  ...
                  <div className="bg-slate-50 dark:bg-slate-900 border-l-2 border-[#d4af37] p-4 rounded-r-lg space-y-2">
                    <span className="text-sm font-mono font-bold text-[#d4af37] uppercase tracking-wide">💡 Faturamento e PIX Integrado</span>
                    <p className="text-base sm:text-lg text-slate-650 dark:text-slate-350 leading-relaxed font-normal">
                ...
                {/* Screenshot Placeholder */}
                <div className="lg:col-span-2 border border-[#d4af37] rounded-xl p-5 bg-slate-50 dark:bg-[#070a13] font-mono text-sm text-slate-650 dark:text-slate-350 space-y-4 relative shadow-md">
                  <span className="absolute top-2 right-2 text-xs sm:text-sm uppercase tracking-wider text-[#d4af37] border border-[#d4af37]/30 px-2 py-0.5 rounded bg-[#d4af37]/5 font-bold">Screenshot: Contratos</span>
                  
                  <div className="space-y-2 font-sans">
                    <label className="text-xs sm:text-sm font-bold text-slate-450 uppercase block">Selecionar Prontuário</label>
                    <div className="border border-slate-300 dark:border-slate-800 p-3 rounded-lg bg-white dark:bg-slate-900 text-[#0f1e36] dark:text-slate-100 flex items-center justify-between text-xs sm:text-sm">
                      <span>👤 Dra. Laura Azevedo (Médica Dermatologista)</span>
                      <span className="text-xs sm:text-sm font-bold text-emerald-500 bg-emerald-500/10 px-2 py-0.5 rounded">Ativo</span>
                    </div>
                  </div>

                  <div className="bg-white dark:bg-slate-900 border border-slate-250 dark:border-slate-800 rounded-lg p-3.5 space-y-2 text-[#0f1e36] dark:text-slate-150 font-sans">
                    <div className="flex justify-between items-center text-xs sm:text-sm font-bold border-b border-slate-100 dark:border-slate-800 pb-2">
                      <span>VALOR DO CONTRATO</span>
                      <span className="text-emerald-600 font-mono text-sm sm:text-base">R$ 12.500,00</span>
                    </div>
                  ...
                  <div className="flex gap-2">
                    <div className="flex-1 bg-slate-200 dark:bg-slate-850 py-2 rounded text-center text-slate-700 dark:text-slate-300 font-sans font-bold text-xs sm:text-sm">Previa do PDF</div>
                    <div className="flex-1 bg-[#d4af37] text-[#070a13] py-2 rounded text-center font-sans font-bold text-xs sm:text-sm">Ativar e Cobrar</div>
                  </div>
                </div>
              </div>
            )}
            ...
            {(activeModule === "perfil" || activeSection === "todos") && (
              <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 items-start pt-6 border-t border-slate-100 dark:border-slate-900/60 animate-slideDown">
                <div className="lg:col-span-3 space-y-4">
                  ...
                  <div className="bg-slate-50 dark:bg-slate-900 border-l-2 border-[#d4af37] p-4 rounded-r-lg space-y-2">
                    <span className="text-sm font-mono font-bold text-[#d4af37] uppercase tracking-wide">💡 Importação Facilitada</span>
                    <p className="text-base sm:text-lg text-slate-650 dark:text-slate-350 leading-relaxed font-normal">
                ...
                {/* Screenshot Placeholder */}
                <div className="lg:col-span-2 border border-[#d4af37] rounded-xl p-5 bg-slate-50 dark:bg-[#070a13] font-mono text-sm text-slate-650 dark:text-slate-350 space-y-4 relative shadow-md">
                  <span className="absolute top-2 right-2 text-xs sm:text-sm uppercase tracking-wider text-[#d4af37] border border-[#d4af37]/30 px-2 py-0.5 rounded bg-[#d4af37]/5 font-bold">Screenshot: Assinatura</span>
                  
                  <div className="space-y-2 font-sans">
                    <span className="text-xs sm:text-sm font-bold uppercase text-slate-450">Quadro de Captura OAB</span>
                    <div className="w-full h-24 bg-white dark:bg-slate-900 rounded-lg border border-dashed border-[#d4af37]/45 flex flex-col items-center justify-center cursor-crosshair text-slate-400 relative">
                      ...
                      <span className="text-xs sm:text-sm">Assine aqui dentro</span>
                  ...
                  <div className="flex gap-2">
                    <button type="button" className="flex-1 bg-slate-200 dark:bg-slate-800 py-2 rounded font-sans font-bold text-slate-700 dark:text-slate-300 text-xs sm:text-sm">Limpar Canvas</button>
