...
export const ModalManual: React.FC<ModalManualProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <>
        ...
        <div className="bg-white dark:bg-slate-950 border border-[#d4af37]/35 rounded-2xl p-6 max-w-sm w-full shadow-2xl space-y-5 text-center transition-colors duration-300">
          ...
          <div className="flex flex-col gap-2">
            <button
              ...
              className="w-full bg-[#0f1e36] text-white hover:bg-slate-800 text-sm font-bold uppercase py-3 rounded-xl border-b-2 border-[#d4af37] shadow-md transition-all active:scale-[0.98] cursor-pointer"
            >
            ...
            <button
              type="button"
              onClick={onClose}
              className="w-full bg-slate-100 hover:bg-slate-200 dark:bg-slate-900 dark:hover:bg-slate-850 text-slate-500 dark:text-slate-400 text-sm font-bold uppercase py-2.5 rounded-xl transition-all cursor-pointer"
            >
              Fechar
            </button>
          </div>
      ...
      <div className="hidden print:block bg-white text-black p-8 max-w-5xl mx-auto font-sans leading-relaxed text-sm">
        ...
        <div className="flex items-center gap-4 pb-4 border-b-2 border-[#d4af37] mb-8">
          ...
          <div>
            <h1 className="font-playfair font-extrabold text-2xl text-[#0f1e36] tracking-wider uppercase m-0">
        ...
        <div className="space-y-6">
          <h2 className="font-playfair font-extrabold text-xl text-[#0f1e36] border-b border-slate-200 pb-1.5 uppercase tracking-wide">
            Diretrizes Operacionais e Procedimentos Padrão (POPs)
          </h2>

          {/* Jus IA */}
          <div className="space-y-2">
            <h3 className="font-bold text-sm text-[#0f1e36] uppercase tracking-wider flex items-center gap-1.5">
            ...
            <ul className="list-disc pl-5 text-sm text-slate-700 font-light space-y-1">
          ...
          {/* Reset de Contratos */}
          <div className="space-y-2">
            <h3 className="font-bold text-sm text-[#0f1e36] uppercase tracking-wider">
        ...
        {/* Rodapé de Impressão */}
        <footer className="text-xs text-center text-slate-400 border-t border-slate-200 pt-8 mt-12">
