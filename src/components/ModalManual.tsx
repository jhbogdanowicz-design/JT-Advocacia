...
export const ModalManual: React.FC<ModalManualProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-900/60 backdrop-blur-sm px-4 print:hidden animate-fadeIn">
        <div className="bg-white dark:bg-slate-950 border border-[#d4af37]/35 rounded-2xl p-6 max-w-sm w-full shadow-2xl space-y-5 text-center transition-colors duration-300">
          ...
          <div className="space-y-2">
            ...
            <h3 className="font-playfair font-extrabold text-[#0f1e36] dark:text-slate-100 text-lg md:text-xl uppercase tracking-wide">
              Manual do Usuário
            </h3>
          ...
          <p className="text-lg text-slate-650 dark:text-slate-350 font-normal leading-relaxed">
          ...
          <div className="flex flex-col gap-2">
            <button
              ...
              className="w-full bg-[#0f1e36] text-white hover:bg-slate-800 text-base font-bold uppercase py-3 rounded-xl border-b-2 border-[#d4af37] shadow-md transition-all active:scale-[0.98] cursor-pointer"
            >
            ...
            <button
              type="button"
              onClick={onClose}
              className="w-full bg-slate-100 hover:bg-slate-200 dark:bg-slate-900 dark:hover:bg-slate-850 text-slate-500 dark:text-slate-400 text-base font-bold uppercase py-2.5 rounded-xl transition-all cursor-pointer"
            >
              Fechar
            </button>
          </div>
      ...
      <div className="hidden print:block bg-white text-black p-8 max-w-5xl mx-auto font-sans leading-relaxed text-lg">
        ...
        <div className="flex items-center gap-4 pb-4 border-b-2 border-[#d4af37] mb-8">
          ...
          <div>
            <h1 className="font-playfair font-extrabold text-3xl text-[#0f1e36] tracking-wider uppercase m-0">
              Janaina Tarabauca Advogados
            </h1>
            <p className="text-base uppercase tracking-widest text-[#d4af37] font-bold mt-0.5">
        ...
        <div className="space-y-6">
          <h2 className="font-playfair font-extrabold text-3xl text-[#0f1e36] border-b border-slate-200 pb-1.5 uppercase tracking-wide">
            Diretrizes Operacionais e Procedimentos Padrão (POPs)
          </h2>

          {/* Jus IA */}
          <div className="space-y-2">
            <h3 className="font-bold text-lg text-[#0f1e36] uppercase tracking-wider flex items-center gap-1.5">
              🤖 1. Motor Jus IA — Geração de Teses Tripartite
            </h3>
            <p className="text-lg text-slate-750 font-normal">
            ...
            <ul className="list-disc pl-5 text-lg text-slate-750 font-normal space-y-1">
          ...
          {/* Reset de Contratos */}
          <div className="space-y-2">
            <h3 className="font-bold text-lg text-[#0f1e36] uppercase tracking-wider">
        ...
        {/* Rodapé de Impressão */}
        <footer className="text-base text-center text-slate-500 border-t border-slate-200 pt-8 mt-12">
